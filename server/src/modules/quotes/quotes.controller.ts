...
export class QuotesController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new quote. Requires authentication. Any authenticated user can submit quotes.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve quotes with various filtering options including character, chapter range, and text search.',
  })
  @ApiQuery({
    name: 'characterId',
    required: false,
  ...
  @ApiQuery({
    name: 'chapterNumber',
    required: false,
    description: 'Filter by specific chapter number',
  })
  @ApiQuery({
    name: 'chapterStart',
    required: false,
    description: 'Filter by chapter range start',
  })
  @ApiQuery({
    name: 'chapterEnd',
    required: false,
    description: 'Filter by chapter range end',
  })
  @ApiQuery({
    name: 'search',
    required: false,
    description: 'Search in quote text and description',
  })
  @ApiQuery({
    name: 'submittedById',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a random quote with optional filtering by character or chapter range.',
  })
  @ApiQuery({
    name: 'characterId',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Search for quotes containing specific text in quote content or description.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a specific quote by its ID with related character and submitter information.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update a quote. Users can only update their own quotes. Moderators and administrators can update any quote.',
  })
  @ApiParam({ name: 'id', description: 'Quote ID' })
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden - can only update own quotes unless moderator/admin',
  })
  @ApiResponse({
    status: 404,
  ...
  @ApiOperation({
    ...
    description:
      'Delete a quote. Users can only delete their own quotes. Moderators and administrators can delete any quote.',
  })
  @ApiParam({ name: 'id', description: 'Quote ID' })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden - can only delete own quotes unless moderator/admin',
  })
  @ApiResponse({
    status: 404,
    description: 'Quote not found',
  ...
  @ApiOperation({
    ...
    description:
      'Delete all quotes for a specific character. Requires moderator or administrator role.',
  })
  @ApiParam({ name: 'characterId', description: 'Character ID' })
  @ApiResponse({
    status: 200,
  ...
  async bulkDeleteByCharacter(
    ...
    const deletedCount =
      await this.quotesService.bulkDeleteByCharacter(characterId);
