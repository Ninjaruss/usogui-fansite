...
export class TranslationsController {
  ...
  @ApiResponse({ 
    ...
    schema: {
      oneOf: [
        {
          type: 'array',
          description: 'Array of all translations when no language filter is applied',
          items: {
            type: 'object',
            properties: {
              id: { type: 'number', example: 1 },
              language: { type: 'string', enum: Object.values(Language), example: 'ja' },
              name: { type: 'string', example: 'ウソウギ' },
              description: { type: 'string', example: '賭博の世界で生きる嘘喰いの物語' },
  ...
  @ApiOperation({ 
    ...
    description: 'Update an existing translation. Requires moderator or admin privileges. Only provided fields will be updated.'
  })
  @ApiParam({
    name: 'entityType',
  ...
  @ApiOperation({ 
    ...
    description: 'Delete a translation. Requires moderator or admin privileges. This action cannot be undone.'
  })
  @ApiParam({
    name: 'entityType',
    description: 'Type of entity the translation belongs to',
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve statistics about translation coverage and progress. Requires moderator or admin privileges.'
  })
  @ApiResponse({ 
    status: 200, 
