    ...
    const initialArcs = [
      {
        ...
        order: 0,
  description: 'Introduction to the world of underground gambling and Baku Madarame\'s unique abilities. This arc establishes the foundation of the story, introducing key characters, the concept of lie detection, and the dangerous nature of high-stakes gambling.',
        startChapter: 1,
        endChapter: 10,
      },
      {
      ...
      },
      {
        name: 'Protoporos Arc',
        order: 3,
  description: 'A complex gambling game involving mathematical strategy and psychological manipulation. This arc showcases the intellectual depth of the story\'s games.',
        startChapter: 46,
        endChapter: 65,
      },
      {
