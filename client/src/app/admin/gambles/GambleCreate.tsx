import { Create, SimpleForm, TextInput, NumberInput, ReferenceArrayInput, SelectArrayInput, ArrayInput, SimpleFormIterator, ReferenceInput, SelectInput } from 'react-admin';
