...
export async function generateMetadata({ searchParams }: QuotesPageProps) {
  ...
  let title = 'Quotes - Usogui Database'
  ...
  if (characterId && search) {
    title = `Quotes matching "${search}" by character - Page ${page} - Usogui Database`
    ...
    title = page > 1
      ? `Character Quotes - Page ${page} - Usogui Database`
      : 'Character Quotes - Usogui Database'
