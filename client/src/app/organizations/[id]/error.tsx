...
export default function OrganizationError({
  ...
  useEffect(() => {
    console.error('[OrganizationError] Error loading organization:', error)
  }, [error])
  ...
  let title = 'Error Loading Organization'
  let message = 'We encountered an error while loading this organization.'

  if (isNotFound) {
    title = 'Organization Not Found'
    message = "This organization doesn't exist or may have been removed."
